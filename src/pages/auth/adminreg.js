...
//         user_id: user.uid,
//         createdAt: new Date(),
//         profile_image: passportFile,
//         identificationDocuments: idFile,
...
//         // approved_by_number: currentUser.phone_number,
//         approved_by_name: `${currentUser.first_name || ''} ${currentUser.last_name || ''}`.trim(),
//       });
